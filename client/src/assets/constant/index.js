export const footerLink = [
  ...
  {
    title: "QUESTIONS",
    listLink: ["FAQS", "RESELLER", "How to order", "How to measure"],
  },
  {
    title: "EXPERIENCE",
    listLink: ["blog hoi an", "tip for custom tailor", "Customer Review"],
  },
];
...
export const footerContact = [
  {
    title: "ADDRESS",
    content:
      "62 Tran Hung Dao St., - 40 Le Loi St., Hoi An City, Quang Nam Province, Vietnam",
    icon: <i className="fi fi-ss-marker"></i>,
  },
  {
    title: "EMAIL",
    content: "info@adongsilk.com",
    icon: <i className="fi fi-ss-envelope"></i>,
  },
  {
    title: "PHONE",
    content: "(+84) 235 3910 579",
    icon: <i className="fi fi-ss-circle-phone-flip"></i>,
  },
];
